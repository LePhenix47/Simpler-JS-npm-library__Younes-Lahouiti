 ...
 */
export function matchRegExp(string, regularExpression) {
 ...
 */
export function getSubtring(string, startIndex, endIndex) {
 ...
 */
export function generateUnicodeCharFromRange(startCodePoint, endCodePoint) {
    var characterList = [];
 ...
 */
export function parseToJS(string) {
 ...
 */
export function stringifyToJSON(value) {
