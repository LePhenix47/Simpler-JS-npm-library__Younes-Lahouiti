...
exports.joinArrayOnChar = exports.spliceArray = exports.getArrayFrom = exports.isValueArray = void 0;
/**
 ...
 */
function getArrayFrom(arrayToCopy) {
 ...
 */
function spliceArray(originalArray, startIndex, deleteCount) {
    var items = [];
 ...
 */
function joinArrayOnChar(array, char) {
    if (char === void 0) { char = ""; }
    return array.join(char);
}
exports.joinArrayOnChar = joinArrayOnChar;
/**
