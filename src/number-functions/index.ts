 ...
 * @param {boolean} includeMin - Whether to include the minimum value in the range, default set to `true`.
 * @param {boolean} includeMax - Whether to include the maximum value in the range, default set to `false`.
 *
